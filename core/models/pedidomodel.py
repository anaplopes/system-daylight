...
class Pedido(models.Model):
    ...
    numero_pedido = models.IntegerField('Numero do Pedido', unique=True, null=False, blank=False, default=1)
    ...
    def save(self, *args, **kwargs):
        if self._state.adding:
            last_pedido = self.objects.all().aggregate(largest=models.Max('numero_pedido'))['largest']
